...
4. 자기 폴더(agents/A0004/) 안에서만 데이터를 읽고 써라. 다른 에이전트 폴더에 직접 접근하지 마라.
...
{"msg_id":"","from":"A0004","to":"수신ID","type":"request|response|report|alert","priority":"low|normal|high|critical","timestamp":"ISO8601","payload":{},"requires_ack":bool}
